...
export function Header() {
    ...
    return (
        <>
            {/* Header Desktop */}
            <motion.header
                className={`w-full fixed top-0 left-0 z-50 py-4 px-6 flex justify-between items-center transition-all duration-300 ${isOpen
            ...
            >
                ...
                <nav className="hidden sm:flex items-center gap-8 text-[16px] text-white/75">
                    ...
                    <Link to="/links" className="hover:text-green-400 transition-all duration-300">
                        Links
                    </Link>
                ...
                <AnimatePresence>
                    {isOpen && (
                        ...
                        >
                            ...
                            <Link to="/links" className="hover:text-green-600 transition-all duration-300 font-medium">
                                Links
                            </Link>
